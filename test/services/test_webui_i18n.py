...
ENGLISH_FALLBACK_KEYS = frozenset(
    {
        ...
        "AI Image Generation (Flux, Midjourney, DALL-E)",
        "Kie.ai AI Video (Kling, Wan, Seedance)",
        "Kie.ai AI Video Models",
        "Video Generation Model",
        "AI Image Generation Studio",
        "Image Provider",
        "Image Model",
        "Visual Style Preset",
        "Per-Scene Image Preview & Control",
        "Generate & Preview All Scene Images",
        "Clear Preview Images",
        "Generated Scene Previews:",
        "Please enter your Kie.ai API Key in Basic Settings to use Kie.ai Video models.",
        "Please enter your Kie.ai API Key in Basic Settings.",
        "Please enter your OpenAI API Key in Basic Settings.",
