...
st.set_page_config(
    ...
    menu_items={
        "Report a bug": "https://www.linkedin.com/in/osama-kamel-dev/",
        "About": "# elSandoo2 el a5dar\n\nAI Automated Video Generator\n\nDeveloped & Customized by **Recode Developments**\n\n[Visit LinkedIn Profile](https://www.linkedin.com/in/osama-kamel-dev/)",
    },
)
...
def _render_brand(available_update: str | None = None):
    """渲染项目名称、当前版本和可选的更新入口。"""
    logo_file = os.path.join(root_dir, "webui", "logo.jpg")
    logo_tag = ""
    if os.path.exists(logo_file):
        try:
            ...
            logo_tag = f'<img src="data:image/jpeg;base64,{b64_logo}" style="height: 48px; vertical-align: middle; margin-right: 14px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">'
        except Exception:
            logo_tag = ""
    ...
    st.markdown(
        ...
        <div style="display: flex; align-items: center; margin-bottom: 8px;">
            {logo_tag}
            <h1 class="mpt-brand" style="margin: 0; display: inline-block;">
                <span class="mpt-brand__name" style="color: #2e7d32; font-weight: 800; font-size: 2rem;">Elsandoo2 Ela5dar</span>
                <a class="mpt-brand__version"
                   href="https://www.linkedin.com/in/osama-kamel-dev/"
                   target="_blank"
                   rel="noopener noreferrer"
                   aria-label="Recode Developments on LinkedIn"
                   title="by Recode Developments"
                   style="color: #666; font-size: 0.95rem; margin-left: 12px; text-decoration: none;">by Recode Developments</a>
            </h1>
        </div>
        """,
        ...
        with st.container(border=True):
            ...
            if params.video_source == "local":
                ...
                uploaded_files = st.file_uploader(
                    "Upload Custom Images (JPG, PNG, WebP) or Video Clips (MP4, MOV)",
...
def _render_application():
    ...
    st.markdown(
        """
        <div style="text-align: center; margin-top: 60px; padding: 25px 0 15px 0; border-top: 1px solid #e0e0e0;">
            <p style="color: #666; font-size: 0.95rem; margin: 0;">
                Made with ❤️ by 
                <a href="https://www.linkedin.com/in/osama-kamel-dev/" target="_blank" 
